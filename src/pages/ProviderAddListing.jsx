...
export default function ProviderAddListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFeedback({ type: 'success', message: 'Room listed successfully!' })
            setTimeout(() => {
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                <section className="dashboard-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
                        ...
                        <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                            <input type="checkbox" checked={amenities.hot_water} onChange={() => handleAmenityToggle('hot_water')} style={{ width: '18px', height: '18px', accentColor: 'var(--accent)' }} />
                            Hot Water / Geyser
                        </label>

                        <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                            <input type="checkbox" checked={amenities.kitchen} onChange={() => handleAmenityToggle('kitchen')} style={{ width: '18px', height: '18px', accentColor: 'var(--accent)' }} />
                            Kitchen Access
                        </label>

                        <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                            <input type="checkbox" checked={amenities.balcony} onChange={() => handleAmenityToggle('balcony')} style={{ width: '18px', height: '18px', accentColor: 'var(--accent)' }} />
                            Balcony
                        </label>

                        <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                            <input type="checkbox" checked={amenities.furnished} onChange={() => handleAmenityToggle('furnished')} style={{ width: '18px', height: '18px', accentColor: 'var(--accent)' }} />
                            Fully Furnished
                        </label>

                        <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                            <input type="checkbox" checked={amenities.ac} onChange={() => handleAmenityToggle('ac')} style={{ width: '18px', height: '18px', accentColor: 'var(--accent)' }} />
                            Air Conditioning
                        </label>
                    </div>
